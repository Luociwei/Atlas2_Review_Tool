...
-- Primary Usage: DFU
-- Input Arguments: nil
-- Return : table, all the versions define in the versionCompare file.
...
-- Created by: Jayson ye 
-- Initial Creation Date :  07/06/2021
-- Current_Version:  1.0
-- Vendor_Name : Microtest
-- Primary Usage: DFU
-- Input Arguments: the input values which define in Tech CSV, the versions which define in versionCompare file.
-- Return : result(Boolean), failureMsg
...
-- Vendor_Name : Microtest
-- Primary Usage: DFU
-- Input Arguments: the paraTab which define in Tech CSV, the versions which define in versionCompare file.
-- Return : result(Boolean), failureMsg
