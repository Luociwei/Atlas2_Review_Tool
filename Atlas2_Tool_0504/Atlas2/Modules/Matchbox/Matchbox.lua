...
function csvCommon.createCommandRecord(paraTab)
...
function csvCommon.createParametricRecord(paraTab)
    return csvCommon.createRecord(paraTab)
end
...
function csvCommon.createRecord(paraTab)
...
function csvCommon.createBinaryRecord(paraTab)
...
-- @return true; the action will always pass
function csvCommon.createPluginRecord(paraTab,actionPlugin,actionFunc)
...
-- Upload attributes
function csvCommon.createAttribute(paraTab)
...
function csvCommon.parse(paraTab)
...
function csvCommon.match(paraTab)
    local inputStr = paraTab.Input
...
local cnt = 1
function csvCommon.sendEFICmd(paraTab)
...
function csvCommon.startCB(param)
...
function csvCommon.finishCB(param)
...
function csvCommon.setVariable(paraTab)
    return paraTab.Input
end

function csvCommon.reportFailure(paraTab)
