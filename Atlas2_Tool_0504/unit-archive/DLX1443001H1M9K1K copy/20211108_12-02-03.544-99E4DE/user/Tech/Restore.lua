...
-- Restore.getRestoreDeviceLogPath( )
...
-- Restore.restoreDFUModeCheck( paraTab )
-- Function to check if the UUT is in DFU Mode
-- Created By : Jayson Ye
-- Initial Creation Date : 15/06/2021
-- Modified By : N/A
-- Modification Date : N/A
...
-- Restore.getLocationID(slot_num, flagIndex, timeout)
-- Function to get the USB LocationID accroding the Slot Number
-- Created By : Jayson Ye
-- Initial Creation Date : 15/06/2021
-- Modified By : N/A
-- Modification Date : N/A
...
-- Restore.checkHangAndKernelPanic( paraTab )
...
-- Primary Usage : DFU
-- Input Arguments : param table
-- Output Arguments : string(The log from uart during the restore process)
-----------------------------------------------------------------------------------]]
...
-- Restore.supplyAceProvisioningPower( paraTab )
...
-- Restore.restoreProcessCheck(paraTab)
