...
-- tech step enabled and condition match, should run
    ...
    if not isActPass then
        ...
        -- 1. user call M:enableSamplingWithoutCB
        -- 2. user call M:startCB and it return true
        -- conditions.enableSampling is set to true when
        -- 1. user call M:disableSampling
        if stepInfo.TestActions == 'M:enableSamplingWithoutCB' then
        ...
        elseif stepInfo.TestActions == 'M:disableSampling' then
