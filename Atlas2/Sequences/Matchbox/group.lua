...
local initGlobals = {TRUE=true, FALSE=false}
local initConditions = {didSOF="FALSE", didFail="FALSE", Poison="FALSE", testFail="FALSE"}
...
function groupSetup(resourcesURLs)
  ...
  return loadGroupPlugins(resourcesURLs)
end
...
function deviceStart(deviceName)
  local devicePlugins = userPluginModule.loadPlugins(deviceName, {})
