...
function GSMConfiguration.registerAutomatedHandlingCallback(readyForAutomatedHandlingCallbackCallback)
  assertSystemStillEditable()
  registeredConfiguration[_readyForAutomatedHandlingCallback] = readyForAutomatedHandlingCallbackCallback
end
