...
function func.eloadcurr_step_loop( param )
    ...
    elseif param.AdditionalParameters.param2 ~= nil then
        ...
        for i=start,stop,step do
            ...
            eload.set_ccload({Commands=cmd1,AdditionalParameters={testname=testname,subtestname=subtestname,subsubtestname=subsubtestname,record="NO"}})
            ...
            if OC_flag>0 then
                if i == start then                 
                    ...
                    eload.set_ccload({Commands=cmd2,AdditionalParameters={testname=testname,subtestname=subtestname,subsubtestname=subsubtestname,record="NO"}})
                    value =  i-step
                    result = true
                    break
                end
...
function func.sendcmd( param )
    ...
    flow_log.writeFlowLog("uart_set.write()")
