...
function func.dmm(netname,param,units)
    ...
    flow_log.writeFlowLog(netname.." "..tostring(option).." "..tostring(count).." "..tostring(sample_rate).." "..tostring(measure_time))
