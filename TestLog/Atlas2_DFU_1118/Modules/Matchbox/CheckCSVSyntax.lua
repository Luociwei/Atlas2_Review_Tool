        ...
        if i ~= 1 then
            ...
            if Thread ~= "" then
                if Thread ~= tempThreadFlag then
                    if comFunc.hasVal(threadFlagArr, Thread) then
                        reportStr2 = TestName
            ...
            if Sample ~= "" then
                if Sample ~= tempSampFlag then
                    if comFunc.hasVal(sampFlagArr, Sample) then
                        reportStr2 = TestName
        ...
        if not isCSVValid then
            ...
            for i, v in ipairs(csvTable) do
                if i ~= 1 then
                    ...
                    -- 1. empty 2. Y 3. N
                    local Disable = v[3]
                    if comFunc.isCharBooleanOrEmpty(Disable) == false then
                        reportStr2 = "Row " .. i
                    ...
                    if isFailureCSV == false then
                        local ExitEarly = v[9]
                        if comFunc.isCharBooleanOrEmpty(ExitEarly) == false then
                            reportStr2 = "Row " .. i
                        ...
                        if comFunc.isCharBooleanOrEmpty(SetPoison) == false then
                            reportStr2 = "Row " .. i
