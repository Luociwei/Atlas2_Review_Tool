...
//    }
    ...
    for (NSString *luaFile in luaFiles) {
        ...
        NSString *patter =[NSString stringWithFormat:@"function\\s+\\w+%@",functionName];
        NSMutableArray *results =[luaContent cw_regularWithPattern:patter];
        if (results.count) {//functionName
