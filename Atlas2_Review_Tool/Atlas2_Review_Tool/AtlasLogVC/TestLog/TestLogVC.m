...
-(void)viewWillAppear{
    ...
    NSArray *systemFiles = [FileManager cw_findPathWithfFileNames:@[@".log",@".txt"] dirPath:systemPath deepFind:NO];
    NSArray *userFiles = [FileManager cw_findPathWithfFileNames:@[@"uart.log"] dirPath:userPath deepFind:NO];
